...
function App() {
  ...
  useEffect(() => {
    fetch(import.meta.env.BASE_URL + 'data.json') // ✅ Fetches correctly for GitHub Pages
        ...
        <article className='bg-white rounded-2xl'>
          ...
          <article className='pt-8 border-t border-slate-200 flex items-center justify-between'>
            <h2 className='font-bold text-4xl p-4'>
              <span className='text-base opacity-55 font-normal block'>Total this month</span>
              $478.33
            </h2>
            <h3 className='pad-ding flex items-end justify-end flex-col text-base font-bold'>
